...
export type SupplierPortalView = { businessDetails?: SupplierBusinessDetails; tradingProfile?: TradingProfile | null; portalId: string; restaurantName: string; supplierName: string; expiresAt: string; orders: PortalOrder[]; forecasts: PortalForecast[] };
